...
(LaTeXList, ControlSequence, Environment, Word,
 ...
 LeftBracket, RightBracket, Space, NewLine, Comment, Parameter, Paragraph)
...
class Parser(Lexer):
    ...
    def BEGINENV(self):
        ...
        strmatch = self.value
        name = Lexer.BEGINENV.rege.match(strmatch).group(1)
    ...
    def ENDENV(self):
        strmatch = self.value
        return Lexer.ENDENV.rege.match(strmatch).group(1)
    ...
    def CONTROLSEQ(self):
        ...
        strmatch = self.value
        csname = Lexer.CONTROLSEQ.rege.match(strmatch).group(1)
