...
var Overlay = function(canvasid, g){
	...
	if (mouseDown)
	{
	    ...
	    ctx.beginPath();
	    ctx.rect(x0, y0, evt.clientX - x0, evt.clientY - y0);
	    ctx.strokeStyle='red';
	    ctx.stroke();
	...
	v1 = g.canvasTocoord(evt.clientX, evt.clientY);
	...
	document.inpform.xmi.value = xmin.toString();
	document.inpform.xma.value = xmax.toString();
	document.inpform.ymi.value = ymin.toString();
	document.inpform.yma.value = ymax.toString();
